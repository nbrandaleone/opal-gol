...
Opal.modules["opal/jquery/constants"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $truthy = Opal.truthy, $const_set = Opal.const_set, $a, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;
...
Opal.modules["opal/jquery/element"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $defs = Opal.defs, $slice = Opal.slice, $send = Opal.send, $to_a = Opal.to_a, $def = Opal.def, $alias = Opal.alias, $return_self = Opal.return_self, $truthy = Opal.truthy, $send2 = Opal.send2, $find_super = Opal.find_super, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $defs(self, '$expose', function $$expose($a) {
      ...
      return $send(methods, 'each', [], function $$3(method){var self = $$3.$$s == null ? this : $$3.$$s;
        ...
        if (method == null) method = nil;
        return self.$alias_native(method);}, {$$s: self});
    }, -1);
    ...
    $def(self, '$respond_to_missing?', function $Element_respond_to_missing$ques$16(name, _) {
      ...
      $Element_respond_to_missing$ques$16.$$p = null;
...
Opal.modules["opal/jquery/window"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $module = Opal.module, $klass = Opal.klass, $truthy = Opal.truthy, $def = Opal.def, $slice = Opal.slice, $send = Opal.send, $to_a = Opal.to_a, $const_set = Opal.const_set, $gvars = Opal.gvars, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $$$ = Opal.$$$;
...
Opal.modules["opal/jquery/document"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $module = Opal.module, $class_variable_set = Opal.class_variable_set, $truthy = Opal.truthy, $class_variable_get = Opal.class_variable_get, $def = Opal.def, $send = Opal.send, $const_set = Opal.const_set, $gvars = Opal.gvars, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $$$ = Opal.$$$;
  ...
  (function($base, $parent_nesting) {
    ...
    return (function($base, $parent_nesting) {
      ...
      $def(self, '$ready?', function $DocumentMethods_ready$ques$1() {
        ...
        $DocumentMethods_ready$ques$1.$$p = null;
      ...
      $send(self, 'ready?', [], function $DocumentMethods$3(){
        return $class_variable_set($nesting[0], '@@__isReady', true)});
...
Opal.modules["opal/jquery/event"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $assign_ivar = Opal.assign_ivar, $def = Opal.def, $return_ivar = Opal.return_ivar, $alias = Opal.alias, $truthy = Opal.truthy, $rb_lt = Opal.rb_lt, self = Opal.top, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('require,to_n,element,stop,prevent,<,touch_count,prevented?,stopped?,stop_immediate');
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$initialize', $assign_ivar("native"));
    ...
    $def(self, '$touch_count', function $$touch_count() {
      var self = this;

      return self["native"].originalEvent.touches.length
    });
    
    $def(self, '$touch_x', function $$touch_x(index) {
      var self = this;

      
      if (index == null) index = 0;
      if ($truthy($rb_lt(index, self.$touch_count()))) {
        return self["native"].originalEvent.touches[index].pageX
      } else {
        return nil
      };
    }, -1);
    
    $def(self, '$touch_y', function $$touch_y(index) {
      var self = this;

      
      if (index == null) index = 0;
      if ($truthy($rb_lt(index, self.$touch_count()))) {
        return self["native"].originalEvent.touches[index].pageY
      } else {
        return nil
      };
    }, -1);
    ...
    $def(self, '$location', function $$location() {
      ...
      return self["native"].originalEvent.location
    });
...
Opal.modules["opal/jquery/http"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $const_set = Opal.const_set, $send = Opal.send, $defs = Opal.defs, $def = Opal.def, $truthy = Opal.truthy, $return_ivar = Opal.return_ivar, self = Opal.top, $nesting = [], nil = Opal.nil;
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $send($$('ACTIONS'), 'each', [], function $HTTP$1(action){var self = $HTTP$1.$$s == null ? this : $HTTP$1.$$s;
      ...
      return $send(self, 'define_method', [action], function $$4(url, options){var block = $$4.$$p || nil, self = $$4.$$s == null ? this : $$4.$$s;
        ...
        if (url == null) url = nil;
        if (options == null) options = (new Map());
        return self.$send(action, url, options, block);}, {$$arity: -2, $$s: self});}, {$$s: self});
    ...
    $def(self, '$send', function $$send(method, url, options, block) {
      ...
      $a = [self.settings.$to_n(), self.payload.$to_n()], (settings = $a[0]), (payload = $a[1]), $a;
...
Opal.modules["opal/jquery/kernel"] = function(Opal) {/* Generated by Opal 1.8.2 */
...
Opal.modules["opal/jquery"] = function(Opal) {/* Generated by Opal 1.8.2 */
...
Opal.modules["grid"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $const_set = Opal.const_set, $rb_divide = Opal.rb_divide, $def = Opal.def, $truthy = Opal.truthy, $rb_ge = Opal.rb_ge, $rb_plus = Opal.rb_plus, $send = Opal.send, $eqeq = Opal.eqeq, $rb_minus = Opal.rb_minus, $rb_times = Opal.rb_times, $return_val = Opal.return_val, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('attr_reader,attr_accessor,canvas_id,canvas,floor,/,height,width,blank_state,draw_canvas,add_mouse_event_listener,add_demo_event_listener,>=,context,+,new,each,max_x,max_y,[]=,state,==,fill_cell,[],page_y,page_x,Document,e,scrollLeft,documentElement,scrollTop,body,-,*,on,find,get_cursor_position,x,y,<<,seed,unfill_cell,delete,ctrl_d_pressed?,ctrl_key,which');
  
  (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Grid');
    ...
    $const_set($nesting[0], 'CELL_HEIGHT', 15);
    $const_set($nesting[0], 'CELL_WIDTH', 15);
    ...
    $def(self, '$initialize', function $$initialize() {
      ...
      self.max_x = $rb_divide(self.$height(), $$('CELL_HEIGHT')).$floor();
      self.max_y = $rb_divide(self.$width(), $$('CELL_WIDTH')).$floor();
    ...
    $def(self, '$draw_canvas', function $$draw_canvas() {
      ...
      while (!($truthy($rb_ge(y, self.$height())))) {
        ...
        y = $rb_plus(y, $$('CELL_HEIGHT'));
      };
      self.$context().strokeStyle = "#eee";
      return self.$context().stroke();
    });
    
    $def(self, '$blank_state', function $$blank_state() {
      var self = this, h = nil;

      
      h = $$('Hash').$new();
      $send(Opal.Range.$new(0, self.$max_x(), false), 'each', [], function $$1(x){var self = $$1.$$s == null ? this : $$1.$$s;

        
        if (x == null) x = nil;
        return $send(Opal.Range.$new(0, self.$max_y(), false), 'each', [], function $$2(y){var $a;

          
          if (y == null) y = nil;
          return ($a = [[x, y], 0], $send(h, '[]=', $a), $a[$a.length - 1]);});}, {$$s: self});
      return h;
    });
    
    $def(self, '$redraw_canvas', function $$redraw_canvas() {
      var self = this;

      
      self.$draw_canvas();
      return $send(self.$state(), 'each', [], function $$3(cell, liveness){var self = $$3.$$s == null ? this : $$3.$$s;

        
        if (cell == null) cell = nil;
        if (liveness == null) liveness = nil;
        if ($eqeq(liveness, 1)) {
          return self.$fill_cell(cell['$[]'](0), cell['$[]'](1))
        } else {
          return nil
        };}, {$$s: self});
    });
    
    $def(self, '$get_cursor_position', function $$get_cursor_position(event) {
      var self = this, x = nil, y = nil, doc = nil;

      
      console.log(event);
      if (($truthy(event.$page_x()) && ($truthy(event.$page_y())))) {
        ...
        doc = $$('Opal').$Document()['$[]'](0);
        x = $rb_plus($rb_plus(self.$e()['$[]']("clientX"), doc.$scrollLeft()), doc.$documentElement().$scrollLeft());
        y = $rb_plus($rb_plus(self.$e()['$[]']("clientY"), doc.$body().$scrollTop()), doc.$documentElement().$scrollTop());
      };
      x = $rb_minus(x, self.$canvas().offsetLeft);
      y = $rb_minus(y, self.$canvas().offsetTop);
      x = $rb_divide(x, $$('CELL_WIDTH')).$floor();
      y = $rb_divide(y, $$('CELL_HEIGHT')).$floor();
      return $$('Coordinates').$new((new Map([["x", x], ["y", y]])));
    });
    
    $def(self, '$fill_cell', function $$fill_cell(x, y) {
      var self = this;

      
      x = $rb_times(x, $$('CELL_WIDTH'));
      y = $rb_times(y, $$('CELL_HEIGHT'));
      self.$context().fillStyle = "#000";
      return self.$context().fillRect($rb_plus(x.$floor(), 1), $rb_plus(y.$floor(), 1), $rb_minus($$('CELL_WIDTH'), 1), $rb_minus($$('CELL_HEIGHT'), 1));
    });
    
    $def(self, '$unfill_cell', function $$unfill_cell(x, y) {
      var self = this;

      
      x = $rb_times(x, $$('CELL_WIDTH'));
      y = $rb_times(y, $$('CELL_HEIGHT'));
      return self.$context().clearRect($rb_plus(x.$floor(), 1), $rb_plus(y.$floor(), 1), $rb_minus($$('CELL_WIDTH'), 1), $rb_minus($$('CELL_HEIGHT'), 1));
    });
    
    $def(self, '$add_mouse_event_listener', function $$add_mouse_event_listener() {
      var self = this;

      
      $send($$('Element').$find("#" + (self.$canvas_id())), 'on', ["click"], function $$4(event){var $a, self = $$4.$$s == null ? this : $$4.$$s, coords = nil, x = nil, y = nil;
        ...
        self.$fill_cell(x, y);
        return self.$seed()['$<<']([x, y]);}, {$$s: self});
      return $send($$('Element').$find("#" + (self.$canvas_id())), 'on', ["dblclick"], function $$5(event){var $a, self = $$5.$$s == null ? this : $$5.$$s, coords = nil, x = nil, y = nil;
        ...
        return self.$seed().$delete([x, y]);}, {$$s: self});
    });
    
    $def(self, '$canvas_id', $return_val("conwayCanvas"));
    
    $def(self, '$add_demo_event_listener', function $$add_demo_event_listener() {
      var self = this;

      return $send($$('Document'), 'on', ["keypress"], function $$6(event){var self = $$6.$$s == null ? this : $$6.$$s;

        
        if (event == null) event = nil;
        if ($truthy(self['$ctrl_d_pressed?'](event))) {
          return $send([[25, 1], [23, 2], [25, 2], [13, 3], [14, 3], [21, 3], [22, 3], [12, 4], [16, 4], [21, 4], [22, 4], [35, 4], [36, 4], [1, 5], [2, 5], [11, 5], [17, 5], [21, 5], [22, 5], [35, 5], [36, 5], [1, 6], [2, 6], [11, 6], [15, 6], [17, 6], [18, 6], [23, 6], [25, 6], [11, 7], [17, 7], [25, 7], [12, 8], [16, 8], [13, 9], [14, 9]], 'each', [], function $$7(x, y){var self = $$7.$$s == null ? this : $$7.$$s;
    ...
    return $def(self, '$ctrl_d_pressed?', function $Grid_ctrl_d_pressed$ques$8(event) {
      var $ret_or_1 = nil;

      if ($truthy(($ret_or_1 = event.$ctrl_key()['$=='](true)))) {
        return event.$which()['$=='](4)
      } else {
        return $ret_or_1
      }
    });
  })($nesting[0], null, $nesting);
  return ($klass($nesting[0], $$('OpenStruct'), 'Coordinates'), nil);
};

Opal.modules["interval"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $def = Opal.def, $nesting = [], nil = Opal.nil;
  ...
  return (function($base, $super) {
    ...
    $def(self, '$initialize', function $$initialize(time) {
      var block = $$initialize.$$p || nil, self = this;
      ...
      ;
      if (time == null) time = 0;
      return (self.interval = setInterval(function(){block.$call()}, time));
    }, -1);
    return $def(self, '$stop', function $$stop() {
      var self = this;
...
Opal.queue(function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $def = Opal.def, $send = Opal.send, $truthy = Opal.truthy, $rb_lt = Opal.rb_lt, $rb_gt = Opal.rb_gt, $rb_minus = Opal.rb_minus, $rb_plus = Opal.rb_plus, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, game = nil;

  Opal.add_stubs('require,attr_reader,extend,add_enter_event_listener,def_delegators,on,each,seed,[]=,state,enter_pressed?,run,==,which,new,tick,state=,new_state,redraw_canvas,get_state_at,[],is_underpopulated?,is_living_happily?,is_overpopulated?,can_reproduce?,is_alive?,<,population_at,include?,>,is_dead?,reduce,map,-,+,to_proc,!');
  
  self.$require("opal");
  self.$require("opal-jquery");
  self.$require("ostruct");
  self.$require("forwardable");
  self.$require("./conway.rb"+ '/../' + "grid");
  self.$require("./conway.rb"+ '/../' + "interval");
  (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Conway');

    var $nesting = [self].concat($parent_nesting), $$ = Opal.$r($nesting);

    
    self.$attr_reader("grid", "seed");
    self.$extend($$('Forwardable'));
    
    $def(self, '$initialize', function $$initialize(grid) {
      var self = this;

      
      self.grid = grid;
      return self.$add_enter_event_listener();
    });
    self.$def_delegators("@grid", "state", "state=", "redraw_canvas", "seed");
    
    $def(self, '$add_enter_event_listener', function $$add_enter_event_listener() {
      var self = this;

      return $send($$('Document'), 'on', ["keypress"], function $$1(event){var self = $$1.$$s == null ? this : $$1.$$s;

        
        if (event == null) event = nil;
        $send(self.$seed(), 'each', [], function $$2(x, y){var $a, self = $$2.$$s == null ? this : $$2.$$s;

          
          if (x == null) x = nil;
          if (y == null) y = nil;
          return ($a = [[x, y], 1], $send(self.$state(), '[]=', $a), $a[$a.length - 1]);}, {$$s: self});
        if ($truthy(self['$enter_pressed?'](event))) {
          return self.$run()
        } else {
          return nil
        };}, {$$s: self})
    ...
    $def(self, '$enter_pressed?', function $Conway_enter_pressed$ques$3(event) {
      
      return event.$which()['$=='](13)
    });
    
    $def(self, '$run', function $$run() {
      var self = this;

      return $send($$('Interval'), 'new', [], function $$4(){var self = $$4.$$s == null ? this : $$4.$$s;

        return self.$tick()}, {$$s: self})
    });
    
    $def(self, '$tick', function $$tick() {
      var self = this;
    ...
    $def(self, '$new_state', function $$new_state() {
      var self = this, new_state = nil;

      
      new_state = $$('Hash').$new();
      $send(self.$state(), 'each', [], function $$5(cell, _){var $a, self = $$5.$$s == null ? this : $$5.$$s;

        
        if (cell == null) cell = nil;
        if (_ == null) _ = nil;
        return ($a = [cell, self.$get_state_at(cell['$[]'](0), cell['$[]'](1))], $send(new_state, '[]=', $a), $a[$a.length - 1]);}, {$$s: self});
      return new_state;
    });
    
    $def(self, '$get_state_at', function $$get_state_at(x, y) {
      var self = this;

      if ($truthy(self['$is_underpopulated?'](x, y))) {
        return 0
      } else if ($truthy(self['$is_living_happily?'](x, y))) {
        return 1
      } else if ($truthy(self['$is_overpopulated?'](x, y))) {
        return 0
      } else if ($truthy(self['$can_reproduce?'](x, y))) {
        return 1
      } else {
        return nil
      }
    ...
    $def(self, '$is_underpopulated?', function $Conway_is_underpopulated$ques$6(x, y) {
      var self = this, $ret_or_1 = nil;

      if ($truthy(($ret_or_1 = self['$is_alive?'](x, y)))) {
        return $rb_lt(self.$population_at(x, y), 2)
      } else {
        return $ret_or_1
      }
    });
    
    $def(self, '$is_living_happily?', function $Conway_is_living_happily$ques$7(x, y) {
      var self = this, $ret_or_1 = nil;

      if ($truthy(($ret_or_1 = self['$is_alive?'](x, y)))) {
        
        return [2, 3]['$include?'](self.$population_at(x, y));
      } else {
        return $ret_or_1
      }
    });
    
    $def(self, '$is_overpopulated?', function $Conway_is_overpopulated$ques$8(x, y) {
      var self = this, $ret_or_1 = nil;

      if ($truthy(($ret_or_1 = self['$is_alive?'](x, y)))) {
        return $rb_gt(self.$population_at(x, y), 3)
      } else {
        return $ret_or_1
      }
    });
    
    $def(self, '$can_reproduce?', function $Conway_can_reproduce$ques$9(x, y) {
      var self = this, $ret_or_1 = nil;

      if ($truthy(($ret_or_1 = self['$is_dead?'](x, y)))) {
        return self.$population_at(x, y)['$=='](3)
      } else {
        return $ret_or_1
      }
    });
    
    $def(self, '$population_at', function $$population_at(x, y) {
      var self = this;

      return $send([self.$state()['$[]']([$rb_minus(x, 1), $rb_minus(y, 1)]), self.$state()['$[]']([$rb_minus(x, 1), y]), self.$state()['$[]']([$rb_minus(x, 1), $rb_plus(y, 1)]), self.$state()['$[]']([x, $rb_minus(y, 1)]), self.$state()['$[]']([x, $rb_plus(y, 1)]), self.$state()['$[]']([$rb_plus(x, 1), $rb_minus(y, 1)]), self.$state()['$[]']([$rb_plus(x, 1), y]), self.$state()['$[]']([$rb_plus(x, 1), $rb_plus(y, 1)])], 'map', [], "to_i".$to_proc()).$reduce("+")
    });
    
    $def(self, '$is_alive?', function $Conway_is_alive$ques$10(x, y) {
      var self = this;

      return self.$state()['$[]']([x, y])['$=='](1)
    });
    return $def(self, '$is_dead?', function $Conway_is_dead$ques$11(x, y) {
      var self = this;

      return self['$is_alive?'](x, y)['$!']()
    });
  })($nesting[0], null, $nesting);
  return (game = $$('Conway').$new($$('Grid').$new()));
});
